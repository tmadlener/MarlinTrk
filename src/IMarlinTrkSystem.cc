...
void IMarlinTrkSystem::setOption(unsigned CFGOption, bool val) { _cfg.setOption(CFGOption, val); }

bool IMarlinTrkSystem::getOption(unsigned CFGOption) { return _cfg[CFGOption]; }
