...
void MarlinAidaTT::init() {
  ...
  streamlog_out(DEBUG5) << " -------------------------------------------------------------------------------- "
                        << std::endl;
  streamlog_out(DEBUG5) << "  MarlinAidaTT::init() called with the following options :                        "
                        << std::endl;
...
MarlinTrk::IMarlinTrack* MarlinAidaTT::createTrack() {
  ...
  if (!_is_initialised) {
    ...
    errorMsg << "MarlinAidaTT::createTrack: Fitter not initialised. MarlinAidaTT::init() must be called before "
                "MarlinAidaTT::createTrack()"
             << std::endl;
