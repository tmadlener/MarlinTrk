...
public:
  ...
  Exception(const std::string& text) { message = "MarlinTrk::Exception: " + text; }
...
public:
  ...
  /** Return the pointer to the Diagnositics Object. Forseen for internal diagnostics, only available when complied with
   * MARLINTRK_DIAGNOSTICS_ON defined.
   */
