...
void TrkAnalysisTree::CreateBranches(TTree* tree) {
  ...
  //  tree->Branch("mc_track_link_bank_track_index", mc_track_link_bank_track_index
  //  ,"mc_track_link_bank_track_index[mc_track_link_bank_nrels]/I" ); tree->Branch("mc_track_link_bank_rel_weight",
  //  mc_track_link_bank_rel_weight ,"mc_track_link_bank_rel_weight[mc_track_link_bank_nrels]/F" );
  ...
  tree->Branch("tracks_mcp_weight_recp_second", tracks_mcp_weight_recp_second,
               "tracks_mcp_weight_recp_second[ntracks]/F");
  ...
  //  tree->Branch("track_mc_link_bank_mc_index", track_mc_link_bank_mc_index
  //  ,"track_mc_link_bank_mc_index[track_mc_link_bank_nrels]/I" ); tree->Branch("track_mc_link_bank_rel_weight",
  //  track_mc_link_bank_rel_weight ,"track_mc_link_bank_rel_weight[track_mc_link_bank_nrels]/F" );
}
...
void TrkAnalysisTree::Init(TTree* tree) {
  ...
  fChain->SetBranchAddress("mcp_track_weight_recp_second", mcp_track_weight_recp_second,
                           &b_mcp_track_weight_recp_second);
  ...
  //  fChain->SetBranchAddress("mc_track_link_bank_track_index", mc_track_link_bank_track_index,
  //  &b_mc_track_link_bank_track_index ); fChain->SetBranchAddress("mc_track_link_bank_rel_weight",
  //  mc_track_link_bank_rel_weight, &b_mc_track_link_bank_rel_weight );
  ...
  fChain->SetBranchAddress("tracks_mcp_weight_recp_first", tracks_mcp_weight_recp_first,
                           &b_tracks_mcp_weight_recp_first);
  fChain->SetBranchAddress("tracks_mcp_weight_recp_second", tracks_mcp_weight_recp_second,
                           &b_tracks_mcp_weight_recp_second);
  fChain->SetBranchAddress("tracks_mcp_weight_recp_third", tracks_mcp_weight_recp_third,
                           &b_tracks_mcp_weight_recp_third);
  ...
  //  fChain->SetBranchAddress("track_mc_link_bank_mc_index", track_mc_link_bank_mc_index,
  //  &b_track_mc_link_bank_mc_index ); fChain->SetBranchAddress("track_mc_link_bank_rel_weight",
  //  track_mc_link_bank_rel_weight, &b_track_mc_link_bank_rel_weight );
